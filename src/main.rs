...
fn main() {
    ...
    //let limi_translation_0 = Vector!(0.0, 0.0, 0.333).define("limi_translation_0");
    //let limi_translation_1 = Vector!(0.0, 0.0, 0.0).define("limi_translation_1");
    //let limi_translation_2 = Vector!(0.0, -0.316, 0.0).define("limi_translation_2");
    //let limi_translation_3 = Vector!(0.083, 0.0, 0.0).define("limi_translation_3");
    //let limi_translation_4 = Vector!(-0.083, 0.384, 0.0).define("limi_translation_4");
    //let limi_translation_5 = Vector!(0.0, 0.0, 0.0).define("limi_translation_5");
